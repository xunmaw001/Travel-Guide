...
<div :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px auto 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","width":"1200px","position":"relative"}'>
    <el-form
      ...
      label-width="200px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="城市" prop="chengshi">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}'  label="天气" prop="tianqi">
            <el-select v-model="ruleForm.tianqi" placeholder="请选择天气"  >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="气温" prop="qiwen">
            <el-input v-model="ruleForm.qiwen" 
                placeholder="气温" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="湿度" prop="shidu">
            <el-input v-model="ruleForm.shidu" 
                placeholder="湿度" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}'  label="风向" prop="fengxiang">
            <el-select v-model="ruleForm.fengxiang" placeholder="请选择风向"  >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}'  label="风速" prop="fengsu">
            <el-select v-model="ruleForm.fengsu" placeholder="请选择风速"  >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}'  label="适宜出行" prop="shiyichuxing">
            <el-select v-model="ruleForm.shiyichuxing" placeholder="请选择适宜出行"  >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="穿衣推荐" prop="chuanyituijian">
            <el-input v-model="ruleForm.chuanyituijian" 
                placeholder="穿衣推荐" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="更新时间" prop="gengxinshijian" >
              <el-date-picker

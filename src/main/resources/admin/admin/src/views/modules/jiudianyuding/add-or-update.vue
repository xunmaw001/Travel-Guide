	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="酒店类型" prop="jiudianleixing">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="房间类型" prop="fangjianleixing">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="预订说明" prop="yudingshuoming">
					<el-input v-model="ruleForm.yudingshuoming" placeholder="预订说明" clearable  :readonly="ro.yudingshuoming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="预订说明" prop="yudingshuoming">
					<el-input v-model="ruleForm.yudingshuoming" placeholder="预订说明" readonly></el-input>
				</el-form-item>

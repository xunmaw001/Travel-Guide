<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="旅行地点" prop="lvxingdidian">
					<el-input v-model="ruleForm.lvxingdidian" placeholder="旅行地点" clearable  :readonly="ro.lvxingdidian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="旅行地点" prop="lvxingdidian">
					<el-input v-model="ruleForm.lvxingdidian" placeholder="旅行地点" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="旅行类型" prop="lvxingleixing">
					<el-select :disabled="ro.lvxingleixing" v-model="ruleForm.lvxingleixing" placeholder="请选择旅行类型" >
						<el-option
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="旅行类型" prop="lvxingleixing">
					<el-input v-model="ruleForm.lvxingleixing"
						placeholder="旅行类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="旅行天数" prop="lvxingtianshu">
					<el-input v-model="ruleForm.lvxingtianshu" placeholder="旅行天数" clearable  :readonly="ro.lvxingtianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="旅行天数" prop="lvxingtianshu">
					<el-input v-model="ruleForm.lvxingtianshu" placeholder="旅行天数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.lvxingtupian" label="旅行图片" prop="lvxingtupian">
					<file-upload
						tip="点击上传旅行图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.lvxingtupian" label="旅行图片" prop="lvxingtupian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="旅行内容" prop="lvxingneirong">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.lvxingneirong" label="旅行内容" prop="lvxingneirong">

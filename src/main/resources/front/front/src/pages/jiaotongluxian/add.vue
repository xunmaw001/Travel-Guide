...
<div :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px auto 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","width":"1200px","position":"relative"}'>
    <el-form
      ...
      label-width="200px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="路线名称" prop="luxianmingcheng">
            <el-input v-model="ruleForm.luxianmingcheng" 
                placeholder="路线名称" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}'  label="路线类型" prop="luxianleixing">
            <el-select v-model="ruleForm.luxianleixing" placeholder="请选择路线类型"  >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="始发地" prop="shifadi">
            <el-input v-model="ruleForm.shifadi" 
                placeholder="始发地" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="终点地" prop="zhongdiandi">
            <el-input v-model="ruleForm.zhongdiandi" 
                placeholder="终点地" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="全程距离" prop="quanchengjuli">
            <el-input v-model="ruleForm.quanchengjuli" 
                placeholder="全程距离" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="路线图片" v-if="type!='cross' || (type=='cross' && !ro.luxiantupian)" prop="luxiantupian">
            <file-upload
            tip="点击上传路线图片"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' class="upload" v-else label="路线图片" prop="luxiantupian">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="路线详情" prop="luxianxiangqing">
            <editor 

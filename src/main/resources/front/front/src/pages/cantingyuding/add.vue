...
<div :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px auto 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","width":"1200px","position":"relative"}'>
    <el-form
      ...
      label-width="200px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="餐厅名称" prop="cantingmingcheng">
            <el-input v-model="ruleForm.cantingmingcheng" 
                placeholder="餐厅名称" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="餐厅地点" prop="cantingdidian">
            <el-input v-model="ruleForm.cantingdidian" 
                placeholder="餐厅地点" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="预订价格" prop="yudingjiage">
            <el-input v-model="ruleForm.yudingjiage" 
                placeholder="预订价格" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="预订时间" prop="yudingshijian" disabled>
              <el-date-picker
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="预订说明" prop="yudingshuoming">
